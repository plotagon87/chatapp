...
$rolesStmt = $conn->query("SELECT DISTINCT role FROM users ORDER BY role");
$roles = $rolesStmt->fetchAll(PDO::FETCH_COLUMN);

$statusesStmt = $conn->query("SELECT DISTINCT status FROM users ORDER BY status");
...
<body class="bg-gray-100">
    ...
    <nav class="bg-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                <h1 class="text-xl font-bold text-gray-800">All Users</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            <h2 class="text-lg font-bold text-gray-800 mb-4">Filter Users</h2>
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="view_users.php" class="bg-gray-600 text-white px-6 py-2 rounded-lg hover:bg-gray-700">
                        Clear
                    </a>
                </div>
            </form>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h2 class="text-xl font-bold text-gray-800">All Users (<?php echo $totalUsers; ?> total)</h2>
