...
// Build search and filter conditions for online users
$whereConditions = ["status = 'online'"];
$params = [];
...
$rolesStmt = $conn->query("SELECT DISTINCT role FROM users WHERE status = 'online' ORDER BY role");
...
<body class="bg-gray-100">
    ...
    <nav class="bg-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                <h1 class="text-xl font-bold text-gray-800">Online Users</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            <h2 class="text-lg font-bold text-gray-800 mb-4">Filter Online Users</h2>
            <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="view_online_users.php" class="bg-gray-600 text-white px-6 py-2 rounded-lg hover:bg-gray-700">
                        Clear
                    </a>
                </div>
            </form>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h2 class="text-xl font-bold text-gray-800">Online Users (<?php echo $totalUsers; ?> currently online)</h2>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Custom Status</th>
                        ...
                        <?php else: ?>
                            <?php foreach($users as $user): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        <?php echo $user['custom_status'] ? htmlspecialchars($user['custom_status']) : '<span class="text-gray-400">No status</span>'; ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
